...
The study's authors hope that these findings will lead to more personalized and effective weight loss strategies, moving away from the one-size-fits-all approach that has dominated the diet industry.`,
  ...
  {
    id: '1001',
    title: "CRICKET: England clinch dramatic Ashes victory",
    subheading: "England wins the Ashes in a thrilling final day at Lord's",
    content: "England's cricket team secured a historic Ashes victory after a nail-biting finish at Lord's. Fans celebrated as the final wicket fell.",
    author: 'Alex Hales',
    date: '2024-03-16',
    imageUrl: 'https://images.pexels.com/photos/163209/sport-cricket-game-play-163209.jpeg',
    category: 'Sport',
    subcategory: 'Cricket',
    flag: 'Breaking',
    readTime: '3 min read',
    timestamp: '2024-03-16T10:00:00Z',
    tags: ['Cricket', 'Ashes', 'Sport']
  },
  {
    id: '1002',
    title: 'RUGBY UNION: Six Nations preview',
    subheading: 'A look ahead to the upcoming Six Nations tournament',
    content: 'The Six Nations rugby tournament is set to kick off with fierce rivalries and high expectations for all teams involved.',
  ...
  {
    id: '1003',
    title: 'UFC: Title fight announced for summer',
    subheading: 'UFC announces blockbuster summer title fight',
    content: 'The UFC has confirmed a major title fight for this summer, promising fans an unforgettable night of action.',
    author: 'Dana White',
    date: '2024-03-16',
  ...
  {
    id: '1004',
    title: 'WWE: WrestleMania main event set',
    subheading: 'WrestleMania to feature star-studded main event',
    content: "WWE has announced the main event for this year's WrestleMania, featuring some of the biggest names in wrestling.",
  ...
  {
    id: '1005',
    title: 'GOLF: Masters preview',
    subheading: "Golf's biggest stars prepare for the Masters",
    content: "The world's top golfers are gearing up for the Masters, with high hopes and fierce competition expected.",
    author: 'Rory McIlroy',
    date: '2024-03-16',
    ...
    tags: ['Golf', 'Masters', 'Sport']
  },
  {
    id: '1006',
    title: 'TENNIS: Wimbledon returns this summer',
    subheading: 'Wimbledon set for a star-studded return',
    content: 'Tennis fans are eagerly awaiting the return of Wimbledon, with top seeds ready to battle for the title.',
    ...
    tags: ['Tennis', 'Wimbledon', 'Sport']
  },
  {
    id: '1007',
    title: 'NFL: Super Bowl preview',
    subheading: "Everything you need to know about this year's Super Bowl",
    content: "The NFL's biggest game is almost here, with fans and analysts making their predictions for the Super Bowl.",
    author: 'Tom Brady',
    date: '2024-03-16',
    imageUrl: 'https://images.pexels.com/photos/209977/pexels-photo-209977.jpeg',
    category: 'Sport',
    ...
    tags: ['NFL', 'Super Bowl', 'Sport']
  },
  {
    id: '1008',
    title: 'DREAM TEAM: Fantasy football tips for the week',
    subheading: 'Top picks and advice for your Dream Team lineup',
    content: 'Get the latest tips and advice for your fantasy football Dream Team, including must-have players and hidden gems.',
    author: 'Fantasy Expert',
    date: '2024-03-16',
    imageUrl: 'https://images.pexels.com/photos/46798/the-ball-stadion-football-the-pitch-46798.jpeg',
    category: 'Sport',
    subcategory: 'DreamTeam',
    flag: 'Tips',
    readTime: '2 min read',
    timestamp: '2024-03-16T17:00:00Z',
    tags: ['Dream Team', 'Fantasy Football', 'Sport']
  },
  // --- TV ---
  {
    id: '1009',
    title: 'NETFLIX: New original series announced',
    subheading: 'Netflix unveils its latest original drama series',
    content: 'Netflix has announced a new original drama series set to premiere this fall, starring a top Hollywood cast.',
  ...
  {
    id: '1010',
    title: 'AMAZON PRIME: Hit show renewed for another season',
    subheading: "Amazon Prime's top show returns for a new season",
    content: 'Amazon Prime has renewed its hit show for another season, promising more drama and excitement for fans.',
    author: 'Streaming Reporter',
    date: '2024-03-16',
    imageUrl: 'https://images.pexels.com/photos/799137/pexels-photo-799137.jpeg',
    category: 'TV',
    ...
    tags: ['Amazon Prime', 'Streaming', 'TV']
  },
  // --- Showbiz ---
  {
    id: '1011',
    title: 'MUSIC: Chart-topping artist releases new album',
    subheading: 'Music sensation drops highly anticipated album',
    content: 'A chart-topping artist has released a new album, which is already climbing the charts and receiving rave reviews.',
    author: 'Music Critic',
    date: '2024-03-16',
    ...
    tags: ['Music', 'Album', 'Showbiz']
  },
  {
    id: '1012',
    title: 'FILM: Blockbuster movie breaks box office records',
    subheading: 'New film sets box office records on opening weekend',
    content: 'A new blockbuster film has broken box office records, drawing huge crowds and critical acclaim.',
    author: 'Film Critic',
    date: '2024-03-16',
    imageUrl: 'https://images.pexels.com/photos/164936/pexels-photo-164936.jpeg',
    category: 'Showbiz',
    ...
    tags: ['Film', 'Box Office', 'Showbiz']
  },
  {
    id: '1013',
    title: 'ENTERTAINMENT: TV host announces new game show',
    subheading: 'Popular TV host to launch new entertainment show',
    content: 'A well-known TV host is set to launch a new game show, promising fun and excitement for viewers.',
    ...
    tags: ['Entertainment', 'TV', 'Showbiz']
  },
  // --- Lifestyle ---
  {
    id: '1014',
    title: 'FOOD: New restaurant opens in city centre',
    subheading: 'Trendy new eatery draws foodies from across the city',
    content: 'A new restaurant has opened in the city centre, offering a unique menu and stylish atmosphere.',
    author: 'Food Critic',
    date: '2024-03-16',
    ...
    tags: ['Food', 'Restaurant', 'Lifestyle']
  },
  {
    id: '1015',
    title: 'TRAVEL: Top destinations for 2024 revealed',
    subheading: 'Travel experts share their must-visit destinations for the year',
    content: 'Travel experts have revealed their top picks for destinations to visit in 2024, from tropical beaches to bustling cities.',
  ...
  {
    id: '1016',
    title: 'MOTORS: Electric cars gain popularity',
    subheading: 'Electric vehicles are becoming more popular among drivers',
    content: 'The popularity of electric cars continues to rise, with more drivers making the switch to eco-friendly vehicles.',
    ...
    tags: ['Motors', 'Electric Cars', 'Lifestyle']
  },
  // --- Money ---
  {
    id: '1017',
    title: 'BILLS: How to save on your energy bills this winter',
    subheading: 'Expert tips for reducing your household energy costs',
    content: 'Energy experts share their top tips for saving money on your bills this winter.',
    ...
    tags: ['Bills', 'Money', 'Finance']
  },
  {
    id: '1018',
    title: 'PENSIONS: Planning for retirement in 2024',
    subheading: 'What you need to know about pensions this year',
    content: 'Financial advisors share the latest advice on planning for retirement and managing your pension.',
    author: 'Finance Writer',
    date: '2024-03-17',
    imageUrl: 'https://images.pexels.com/photos/7567434/pexels-photo-7567434.jpeg',
    category: 'Money',
    ...
    tags: ['Pensions', 'Retirement', 'Money']
  },
  // --- Tech ---
  {
    id: '1019',
    title: 'SCIENCE: Breakthrough in renewable energy technology',
    subheading: 'Scientists develop new method for clean energy production',
    content: 'A team of scientists has developed a new technology that could revolutionize renewable energy production.',
  ...
  {
    id: '1020',
    title: 'HEALTH NEWS: New health guidelines released',
    subheading: 'Government releases updated health guidelines for 2024',
    content: 'The government has released new health guidelines aimed at improving public health and wellbeing.',
